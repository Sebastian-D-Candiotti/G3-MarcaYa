...
class _RegistrarEmpleadoPageState extends State<RegistrarEmpleadoPage> {
  ...
  Future<void> _consultarDni() async {
    ...
    try {
      final res = await ApiService.instance.consultarReniec(dni);

      if (!mounted) return;

      setState(() {
        _nombreCtrl.text = res['nombres'] as String? ?? '';
        _apellidoCtrl.text = [
  ...
  Future<void> _handleRegistro() async {
    ...
    if (_nombreCtrl.text.trim().isEmpty) {
      setState(() => _error = 'Debés ingresar tu nombre');
      return;
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Ingresá tu DNI para consultar tus datos',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _consultandoDni
                      ...
                      : Text(_dniConsultado ? 'DNI consultado' : 'Consultar DNI'),
                ),
              ),

              // Campos que aparecen después de consultar DNI
              if (_dniConsultado) ...[
