...
class Api::V1::AuthControllerTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @empresa.update_column(:clave_hash, BCrypt::Password.create("plaintext123"))
    @empleado.update_column(:clave_hash, BCrypt::Password.create("pass456"))
    @inactivo.update_column(:clave_hash, BCrypt::Password.create("secret789"))
    @pendiente.update_column(:clave_hash, BCrypt::Password.create("pending123"))
  ...
  test "login empleado with valid credentials returns 200 with token and perfil" do
    post api_v1_auth_login_url,
         params: { correo: @empleado.correo, clave: "pass456", device_id: "is2-device-1" },
         as: :json
