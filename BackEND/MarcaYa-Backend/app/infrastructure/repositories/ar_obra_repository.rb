  ...
  module Repositories
    ...
    class ArObraRepository
      def find_by_id!(id)
        ...
        raise Domain::Errors::ObraNoEncontradaError, "Obra con id #{id} no encontrada"
      end

      def todos
        ::Infrastructure::Orm::ObraRecord.all.map { |r| ::Infrastructure::Mappers::ObraMapper.to_domain(r) }
      end
      ...
      def guardar(obra)
        ...
        raise Domain::Errors::ObraNoEncontradaError, "Obra con id #{obra.id} no encontrada"
      end
