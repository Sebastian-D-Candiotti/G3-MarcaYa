  ...
  module Repositories
    ...
    class ArSolicitudRepository
      def find_by_id!(id)
        ...
        raise Domain::Errors::SolicitudNoEncontradaError, "Solicitud con id #{id} no encontrada"
      end
      ...
      def listar_por_empresa(empresa_id)
        ::Infrastructure::Orm::SolicitudRecord.where(empresa_id: empresa_id).map { |r| ::Infrastructure::Mappers::SolicitudMapper.to_domain(r) }
      end
      ...
      def guardar(solicitud)
        ...
        raise Domain::Errors::SolicitudNoEncontradaError, "Solicitud con id #{solicitud.id} no encontrada"
      end
    end
  end
end
